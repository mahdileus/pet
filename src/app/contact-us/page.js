...
export default function contactUs(){
    return(
        < div className="font-yekan-bakh relative overflow-hidden">
           <ShapeTwo/>
        <Navbar/>
            <section className="container font-yekan-bakh mt-20 md:space-x-4 space-y-4 shadow-md shadow-gray-200 md:px-4 py-8 px-5 rounded-lg">
        <div className=" flex flex-col-reverse  lg:flex-row">
            <div className="lg:w-1/2 w-full space-y-16 p-5">
                <div className="flex items-center gap-3">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#5217f6" class="size-3 bg-primary rounded-full">
                ...
                <form className="space-y-10" autocomplete="on">
                    <div className="space-y-3">
                        <label className="w-full text-[18px] flex items-center gap-1.5" for="name">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#EE273A" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#EE273A" className="size-3">
                    ...
                    <div className="space-y-3">
                        <label className="w-full text-[18px] flex items-center gap-1.5" for="email">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#EE273A" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#EE273A" class="size-3">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                            </svg>
                        </span>
                            <span>آدرس ایمیل</span>
                        </label>
                        <input className="block text-sm text-gray-400 bg-gray-100 rounded-lg w-full px-5 py-4" type="email" id="email" placeholder="آرس ایمیل خودرا وارد نمایید" />
                    </div>

                    <div className="space-y-3">
                        <label className="w-full text-[18px] flex items-center gap-1.5" for="phone">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#EE273A" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#EE273A" class="size-3">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                            </svg>
                        ...
                        <input className="block text-sm text-gray-400 bg-gray-100 rounded-lg w-full px-5 py-4" type="text" id="phone" placeholder="شماره تلفن خودرا وارد نمایید"/>
                    </div>

                    <div className="space-y-3">
                        <label className="w-full text-[18px] flex items-center gap-1.5" for="text">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#EE273A" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#EE273A" class="size-3">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                            </svg>
                        ...
                        <textarea className="block text-sm lin text-gray-400 bg-gray-100 rounded-lg w-full px-5 py-4" id="text" placeholder="پیام خودرا برای ما بفرستید"></textarea>
                    </div>

                    <button type="submit" className="bg-primary rounded-lg text-sm text-white px-10 py-3 cursor-pointer hover:bg-[#ff9f42]">ارسال کنید</button>
                </form>
            </div>


            <div className="w-[1.5px] bg-gray-200 h-[700px] hidden lg:block"></div>


            <div className="lg:w-1/2 w-full p-5 space-y-16">
                <div className="w-full h-80">
                    <img className=" w-full h-full object-fill rounded-lg" src="https://datakadeh.com/Images/ProductImages/af5d80938c7144adae47e599b95c4130.webp" alt="" />
                </div>

                <div className="w-full space-y-3">
                    <div className="flex items-center gap-2">
                        <span className="lg:text-[20px] md:text-[14px]">آدرس ایمیل: </span>
                        <span className="lg:text-[18px] md:text-[14px] text-gray-400"> info@lioncomputer.com</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span className="lg:text-[20px] md:text-[14px]">تلفن: </span>
                        <span className="lg:text-[18px] text-gray-400 md:text-[14px]">91005666-021</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="lg:text-[20px] md:text-[14px]">آدرس دفتر مرکزی: </span>
                        <span className="lg:text-[18px] md:text-[14px] text-gray-400">  تهران، خیابان حافظ، بالاتر از زرتشت، کوچه جاوید، پلاک ۲۴</span>
                    </div>
                </div>
                    ...
                    <ul className="flex items-center gap-2">
                        ...
                        <li>
                            <a href="#" class="grid place-items-center rounded-full">
                                <svg className="bg-primary hover:bg-[#ff9f42] rounded-full p-2 size-10" width="23" height="13" viewBox="0 0 23 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_152_1033)">
                        ...
                        <li>
                            <a href="#" className="grid place-items-center rounded-full">
                                <svg className="bg-primary hover:bg-[#ff9f42] rounded-full p-2 size-10" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            <a href="#" className="social_items grid place-items-center rounded-full">
                                <svg class="bg-primary hover:bg-[#ff9f42] rounded-full p-2 size-10" width="23" height="23" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_152_1039)">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M11 16.5C14.0376 16.5 16.5 14.0376 16.5 11C16.5 7.96243 14.0376 5.5 11 5.5C7.96243 5.5 5.5 7.96243 5.5 11C5.5 14.0376 7.96243 16.5 11 16.5ZM11 14.6667C13.025 14.6667 14.6667 13.025 14.6667 11C14.6667 8.97496 13.025 7.33333 11 7.33333C8.97496 7.33333 7.33333 8.97496 7.33333 11C7.33333 13.025 8.97496 14.6667 11 14.6667Z" fill="white"/>
