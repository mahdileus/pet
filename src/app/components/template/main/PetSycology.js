...
export default function PetSycology() {
    return (
        <div className="container">
            <hr className="text-gray-200 my-12" />
            <div className="flex items-center justify-between">
                <div className="w-1/2 flex items-center justify-start">
                    <img src="/images/Group-164.png" />
                </div>
                <div className="w-1/2">
                    <div>
                        <h2 className="text-3xl font-bold  bg-linear-to-r from-primary to-secondery bg-clip-text text-transparent"> روانشناسی و شناخت پت </h2>
