...
export default function DrugStoreProductCard({ drugStoreProduct }) {
    const discount = drugStoreProduct.discountPercent || 0;
    const price = drugStoreProduct.price || 0;
    ...
    return (
        <div className="overflow-hidden w-full max-w-sm h-[380px] flex flex-col justify-between">
            ...
            <div className="relative w-full h-52 rounded-3xl border bg-white border-gray-100 overflow-hidden shrink-0">
                <Link href={`/products/${drugStoreProduct.slug}`}>
                    <Image
                        src={drugStoreProduct.thumbnail}
                        alt={drugStoreProduct.title}
                        fill
            ...
            <div className="p-4 flex flex-col gap-3 text-right">
                ...
                <div className="flex justify-between items-center mt-3">
                    ...
                    {/* خط جداکننده */}
                    <div className="w-px h-10 bg-gray-900 mx-1"></div>
                    {/* دکمه مشاهده */}
                    <Link
                        href={`/products/${drugStoreProduct.slug}`}
