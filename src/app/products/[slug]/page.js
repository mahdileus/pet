...
export default async function Product({params}) {
    ...
    const product = await ProductModel.findOne({slug}).lean(); // یک محصول
    return (
            ...
            <div className=" container font-yekan-bakh w-full grid place-items-center">
                ...
                <section className="main_container space-y-14 flex flex-col justify-center">
                    ...
                    <div className=" shadow-md shadow-gray-200 px-10 py-10 2x:flex flex-col rounded-lg overflow-hidden gap-4 space-y-10">
                        ...
                        <div className="grid place-items-center">
                            <a href="#" className="group xl:w-1/12 lg:w-[15%] flex items-center justify-center rounded-full border-primary border-2 gap-2 px-2 py-2">
                                ...
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#5217f6" className="size-3">
                    ...
                    <div className="space-y-10">
                        <div className="shadow-md  shadow-gray-200 px-5 py-5 rounded-lg ">
                            <div className="group flex items-center justify-center bg-green-100 rounded-lg p-6 cursor-pointer">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeٌidth="1.5" stroke="#49BE78" className="size-6">
                            ...
                            <div className="p-4 w-full space-y-6">
                                <div className="flex md:flex-row flex-col items-center justify-between w-full gap-5 md:gap-0">
                                    ...
                                    <div className="md:space-y-4 space-y-1">
                                        <ul className="flex justify-between items-center ">
                                            <li className="">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="#ff9f42" viewBox="0 0 24 24" strokeWidth="1" stroke="#ff9f42" className="size-4 ">
                                            ...
                                            <li>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1" stroke="#ff9f42" className="size-4">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                                                </svg>
                                            </li>
                                            <li>
                                ...
                                <div className="flex items-center justify-between">
                                    <a href="#" className="flex items-center gap-3">
                                        ...
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="3" stroke="#5217f6" className="size-4">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                            </svg>
                                        </span>
                                    </a>
                    ...
                    <div className="hidden shadow-md shadow-gray-200 px-5 py-5 rounded-lg ">
                        <div className="group flex items-center justify-center bg-green-100 rounded-lg p-6 cursor-pointer">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#49BE78" className="size-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                                </svg>
                            </span>
                            <span className="text-sm text-[#49BE78] group-hover:text-green-900">
